...
module.exports = {
  ...
  callback: async (client, interaction) => {
    ...
    try {
      ...
      await interaction.editReply({
        content: interaction.guild.iconURL({ dynamic: true }),
        embeds: [],
      });
    } catch (error) {
      await interaction.editReply({
  ...
  name: "server-icon", // Name of the command
  description: "Gets server icon", // Description of the command
  // devOnly: true, // Is a dev only command
  // testOnly: true, // Is a test command
  usage: "/server-icon", // How to use this command. [required], (optional)
  example: "/server-icon", // Example of how to run this command
